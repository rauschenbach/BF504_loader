...
/* Не выключать измерения до перехода в режим определения дрифта */
#define 	ENABLE_MEASURE_TILL_GPS
#undef 		ENABLE_MEASURE_TILL_GPS

/* Выводить принятую NMEA в лог */
#define		ENABLE_DEBUG_NMEA
//#undef		ENABLE_DEBUG_NMEA
...
/* Разрешить чоппер в настройке АЦП  */
#define		ENABLE_ADC_PGA_CHOP
//#undef		ENABLE_ADC_PGA_CHOP


/* Сколько раз в секунду печатать данные АЦП - раз в 600 секунд  и пр. */
#define 	ADC_DATA_PRINT_COEF		600


#define 	TIME_SIXTY_DAYS			5184000	

/* Допустимая ошибка настройки для таймера 1  */
#define		TIM1_GRANT_ERROR  		2


/* Сколько ждать старта ATMEGA при ресете  */
#define		WAIT_START_ATMEGA	250
...
#define		UART_NMEA_SPEED_9600			9600
#define		UART_NMEA_SPEED_115200			115200


/* Скорость порта для модема  */
#define		UART_MODEM_SPEED		57600


/* Скорость порта для обмена с PC  */
